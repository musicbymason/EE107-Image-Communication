...
The transmit Half-Sine eye diagram is almost perfectly overlayed on top of each other. It is shifted slightly to the right, but this makes sense as we took one slice of data off the end so the plots were lined up with each other. This eye is wide
...
![](.images/Q3/Q4_hseye.jpg)


And here is the SRRC eye diagram:

![](.images/Q4/Q4_srrceye.jpg)
